    ...
    for i in range(len(words) - 1):
        ...
        if bigram not in bigram_freqs and trigram in trigram_freqs:
            ...
            if suggestions:
                ...
                # Zawsze wybieraj najbardziej prawdopodobne słowo w przypadku braku idealnego dopasowania
                corrected_sentence.append(sorted(suggestions, key=lambda x: x[1], reverse=True)[0][0][2])  
...
if __name__ == "__main__":
    ...
    test_sentence = "Please strart reading"
